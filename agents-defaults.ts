/**
 * Agents embarqués dans l'extension, au format markdown brut.
 *
 * Servent UNIQUEMENT à `/agents init`, qui les écrit dans ~/.pi/agent/agents/.
 * Ils ne sont jamais chargés implicitement : sans agents sur le disque,
 * discoverAgents() renvoie une liste vide et l'outil orchestrateur le signale.
 *
 * Pas de clé `model:` : un sous-agent hérite du modèle de la session appelante.
 */
